...
vector<string> read_from_files(string file_info, string file_key)
{
    ...
    //// опирование входных данный в другой файл дл€ недопущени€ случайной потери данных...
...
void encr_stream(string file_info, string file_key, Encryptor* encr)
{
    ...
    //ƒобавить проверку на (len_key < len_info)
    //encr->make_key_sequence(); //так делать нельз€, так как make... не переопределена
